...
node {
    git credentialsId: 'github-creds',
        url: 'https://github.com/MohamedBouarada/spring-boot-hello-world', branch: 'master'
}

pipeline {
    agent any
    environment {
        REPOSITORY_URL = 'https://github.com/MohamedBouarada/spring-boot-hello-world'
        DOCKER_HUB_REPO = 'mohamedbouarada/hello-world'
        IMAGE_TAG = 'latest'
